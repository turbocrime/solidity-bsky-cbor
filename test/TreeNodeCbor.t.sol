...
contract TreeNodeCborTest {
    function test_readTreeNode() public pure {
        bytes memory treeNode =
        ...
        require(
            Compare.bytesMatch(
                abi.encodePacked(node.left.sha), hex"6e7335ed248edae3ed49d47b88a5fcad2985e15f416f8ae23a49dfc1231aeb91"
            ),
            "left sha"
        );
